public class TURMPLATZ
{
    ...
    public void Angriff()
    {
        ...
        if(Ziel>=0)
        {
            ...
            if(Gegner[Ziel].Skin.LeseX()>=Geschoss.LeseX()+7 && Geschoss.LeseSichtbar()==true)
            {
                Geschoss.SetzeX(Geschoss.LeseX()+7);
            }
            if(Gegner[Ziel].Skin.LeseX()<=Geschoss.LeseX() && Geschoss.LeseSichtbar()==true)
            {
                Geschoss.SetzeX(Geschoss.LeseX()-5);
            }
        }
        if(Ziel>=0)
        {
            if(Art == "Pfeil")
            {
                if(Gegner[Ziel]!=null)
                {
                    if(Geschoss.Abstand(Gegner[Ziel].Skin)<=Flaeche)
                    {
                        Geschoss.SetzeY(1000);
                        Geschoss.SichtbarSetzen(false);
