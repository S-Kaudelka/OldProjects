public class SUDOKU
{
    ...
    public void SudokuErstellen(int Nummer)
    {
        ...
        //wenn neue Sudokus hinzugefügt werden, die entsprechende Zahl bei der Methode unten eingefügen
    }

    public void ZahlEinsetzen(int Zahl, String Feld)
    {
        if (Zahl > 9 || Zahl < 0)
        {
            SudokuAnzeigen();
        ...
        if (Nummer == 1)
        {
            if (Feld == "A4" || Feld == "A7" || Feld == "A8" || Feld == "B3" || Feld == "B5" || Feld == "B6" || Feld == "B8" || Feld == "B9" || Feld == "C1" || Feld == "C3" || Feld == "C6" || Feld == "D1" || Feld == "D2" || Feld == "D4" || Feld == "D7" || Feld == "D9" || Feld == "E2" || Feld == "E5" || Feld == "E8" || Feld == "F1" || Feld == "F3" || Feld == "F6" || Feld == "F8" || Feld == "F9" || Feld == "G4" || Feld == "G7" || Feld == "G9" || Feld == "H1" || Feld == "H2" || Feld == "H4" || Feld == "H5" || Feld == "H7" || Feld == "I2" || Feld == "I3" || Feld == "I6")
            {
                SudokuAnzeigen();
                System.out.println("");
                System.out.println("In diesem Feld ist keine Eingabe möglich");
                return;
            }
        }
        if (Nummer == 2)
        ...
        else
        {
            SudokuAnzeigen();
            System.out.println("");
            System.out.println("Zahl Eigefügt");
            return;
        }
    }        
    ...
    public void SudokuAnzeigen()
    {
        ...
        System.out.println("A(1)|"+A1+" "+A2+" "+A3+" | "+A4+" "+A5+" "+A6+" | "+A7+" "+A8+" "+A9);
        System.out.println("B(2)|"+B1+" "+B2+" "+B3+" | "+B4+" "+B5+" "+B6+" | "+B7+" "+B8+" "+B9);
        System.out.println("C(3)|"+C1+" "+C2+" "+C3+" | "+C4+" "+C5+" "+C6+" | "+C7+" "+C8+" "+C9);
        System.out.println("     ---------------------");
        System.out.println("D(4)|"+D1+" "+D2+" "+D3+" | "+D4+" "+D5+" "+D6+" | "+D7+" "+D8+" "+D9);
        System.out.println("E(5)|"+E1+" "+E2+" "+E3+" | "+E4+" "+E5+" "+E6+" | "+E7+" "+E8+" "+E9);
        System.out.println("F(6)|"+F1+" "+F2+" "+F3+" | "+F4+" "+F5+" "+F6+" | "+F7+" "+F8+" "+F9);
        System.out.println("     ---------------------");
        System.out.println("G(7)|"+G1+" "+G2+" "+G3+" | "+G4+" "+G5+" "+G6+" | "+G7+" "+G8+" "+G9);
        System.out.println("H(8)|"+H1+" "+H2+" "+H3+" | "+H4+" "+H5+" "+H6+" | "+H7+" "+H8+" "+H9);
        System.out.println("I(9)|"+I1+" "+I2+" "+I3+" | "+I4+" "+I5+" "+I6+" | "+I7+" "+I8+" "+I9);
        System.out.println("");
    }
    ...
    public void GUISudokuErstellen(String Textfeld)
    {
        if(Textfeld == null || Textfeld.equals(""))return;
        double Nummer_GUI = Double.parseDouble(Textfeld);
        if(Nummer_GUI==0.0){Nummer=0;}
        if(Nummer_GUI==1.0){Nummer=1;}
        if(Nummer_GUI==2.0){Nummer=2;}
        //wenn neue Sudokus hinzugefuegt werden, die entsprechende Zahl hier einfue�gen
        SudokuErstellen(Nummer);
        SudokuAnzeigen();
    }
    
    public void GUIZahlEinsetzen(int Zahl_einsetzen ,int F_s, int F_w)
    {
        int Zahl= Zahl_einsetzen;
        String Feld="";
        
        if(F_s==1)
        { if(F_w==1){Feld="A1";}if(F_w==2){Feld="A2";}if(F_w==3){Feld="A3";}if(F_w==4){Feld="A4";}if(F_w==5){Feld="A5";}if(F_w==6){Feld="A6";}if(F_w==7){Feld="A7";}if(F_w==8){Feld="A8";}if(F_w==9){Feld="A9";} }
        if(F_s==2)
        { if(F_w==1){Feld="B1";}if(F_w==2){Feld="B2";}if(F_w==3){Feld="B3";}if(F_w==4){Feld="B4";}if(F_w==5){Feld="B5";}if(F_w==6){Feld="B6";}if(F_w==7){Feld="B7";}if(F_w==8){Feld="B8";}if(F_w==9){Feld="B9";} }
        if(F_s==3)
        { if(F_w==1){Feld="C1";}if(F_w==2){Feld="C2";}if(F_w==3){Feld="C3";}if(F_w==4){Feld="C4";}if(F_w==5){Feld="C5";}if(F_w==6){Feld="C6";}if(F_w==7){Feld="C7";}if(F_w==8){Feld="C8";}if(F_w==9){Feld="C9";} }
        if(F_s==4)
        { if(F_w==1){Feld="D1";}if(F_w==2){Feld="D2";}if(F_w==3){Feld="D3";}if(F_w==4){Feld="D4";}if(F_w==5){Feld="D5";}if(F_w==6){Feld="D6";}if(F_w==7){Feld="D7";}if(F_w==8){Feld="D8";}if(F_w==9){Feld="D9";} }
        if(F_s==5)
        { if(F_w==1){Feld="E1";}if(F_w==2){Feld="E2";}if(F_w==3){Feld="E3";}if(F_w==4){Feld="E4";}if(F_w==5){Feld="E5";}if(F_w==6){Feld="E6";}if(F_w==7){Feld="E7";}if(F_w==8){Feld="E8";}if(F_w==9){Feld="E9";} }
        if(F_s==6)
        { if(F_w==1){Feld="F1";}if(F_w==2){Feld="F2";}if(F_w==3){Feld="F3";}if(F_w==4){Feld="F4";}if(F_w==5){Feld="F5";}if(F_w==6){Feld="F6";}if(F_w==7){Feld="F7";}if(F_w==8){Feld="F8";}if(F_w==9){Feld="F9";} }
        if(F_s==7)
        { if(F_w==1){Feld="G1";}if(F_w==2){Feld="G2";}if(F_w==3){Feld="G3";}if(F_w==4){Feld="G4";}if(F_w==5){Feld="G5";}if(F_w==6){Feld="G6";}if(F_w==7){Feld="G7";}if(F_w==8){Feld="G8";}if(F_w==9){Feld="G9";} }
        if(F_s==8)
        { if(F_w==1){Feld="H1";}if(F_w==2){Feld="H2";}if(F_w==3){Feld="H3";}if(F_w==4){Feld="H4";}if(F_w==5){Feld="H5";}if(F_w==6){Feld="H6";}if(F_w==7){Feld="H7";}if(F_w==8){Feld="H8";}if(F_w==9){Feld="H9";} }
        if(F_s==9)
        { if(F_w==1){Feld="I1";}if(F_w==2){Feld="I2";}if(F_w==3){Feld="I3";}if(F_w==4){Feld="I4";}if(F_w==5){Feld="I5";}if(F_w==6){Feld="I6";}if(F_w==7){Feld="I7";}if(F_w==8){Feld="I8";}if(F_w==9){Feld="I9";} }
        
        ZahlEinsetzen(Zahl, Feld);
    }
}
